            ...
            "artifacts": [
                {
                    ...
                    "provenance": {
                        "heading": artifact.provenance.heading,
                    ...
                    "evidence": {
                        "heading": artifact.evidence.heading,
                        "requiredFields": list(
                    ...
                    "statusSemantics": {
                        "passDefinition": (
                            artifact.status_semantics.pass_definition
                        ),
                        "failDefinition": (
                            artifact.status_semantics.fail_definition
                        ),
                        "blockedDefinition": (
                            artifact.status_semantics.blocked_definition
                        ),
                        "mixedConditionRule": (
                            artifact.status_semantics.mixed_condition_rule
                        ),
                    },
